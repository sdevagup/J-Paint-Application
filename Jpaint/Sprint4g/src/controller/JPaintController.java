...
// setup events method for GUI
    private void setupEvents()
    {
        ...
        moduleUI.addEvent(nameEvent.UNDO, () -> new UndoOperation().run());
        moduleUI.addEvent(nameEvent.REDO, () -> new RedoOperation().run());
        moduleUI.addEvent(nameEvent.COPY, () -> new CopyOperation(stateApp, listShape, shapeConfig).run());
        moduleUI.addEvent(nameEvent.PASTE, () -> new PasteOperation(stateApp, listShape, shapeConfig).run());
        moduleUI.addEvent(nameEvent.DELETE, () -> new DeleteOperation(stateApp, listShape, shapeConfig).run());
